...
- Repository: biteme-official/biteme_wireframes
- Stack: Vanilla HTML / CSS / JS (정적 와이어프레임)
- 배포: Vercel — biteme-wireframes 프로젝트 (GitHub 연동 자동 배포)
- Maintainer: @bmhayoung (main + 배포 권한 독점)
- Developer: 그 외 구성원
...
→ Developer 요청 시 거부, @bmhayoung에게 요청하도록 안내
